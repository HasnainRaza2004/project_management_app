...
export default function AdminDashboard() {
  ...
  const adminMenus = [
    { label: "Manage Users", icon: "account-group", route: "/admin/users" },
    { label: "System Settings", icon: "cog-outline", route: "/admin/setting" },
    { label: "Projects", icon: "clipboard-list-outline", route: "/teacher/projects" },
    { label: "Tasks", icon: "checkbox-marked-outline", route: "/teacher/tasks" },
